...
<div class="container">
    ...
    <div class=" d-flex justify-content-between">
        ...
        <div>
            <a href="<?php echo e(route ('experiences.edit', $experience)); ?>" class="btn btn-primary">Editar</a>
        </div>
        <div>
            <form method="post" action="<?php echo e(route ('experiences.destroy', $experience)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/recap04/resources/views/experiences/show.blade.php ENDPATH**/ ?>