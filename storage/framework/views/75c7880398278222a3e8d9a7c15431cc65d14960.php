...
<div class="container">
<form method="post" action="<?php echo e(route('experiences.store')); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="company" class="form-control" id="company" value="<?php echo e(old('company')); ?>">
          </div>
          <div class="mb-3">
            <label for="from" class="form-label">Desde</label>
            <input type="date" name="from" class="form-control" id="from" value="<?php echo e(old('from')); ?>">
          </div>
          <div class="mb-3">
            <label for="to" class="form-label">Hasta</label>
            <input type="date" name="to" class="form-control" id="to" value="<?php echo e(old ('to')); ?>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="pageurl" class="form-control" id="pageurl" value="<?php echo e(old('pageurl')); ?>">
          </div>
          <div class="mb-3">
            <label for="giturl" class="form-label">Url código</label>
            <input type="text" name="giturl" class="form-control" id="giturl" value="<?php echo e(old('giturl')); ?>">
          </div>
          <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/recap04/resources/views/experiences/create.blade.php ENDPATH**/ ?>