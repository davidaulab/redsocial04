...
@section('content')
       ...
       <div class="container">
           ...
           @auth()
           <div class="d-flex justify-content-center mt-4"><a href="{{ route ('groups.create') }}" class="btn btn-success">Nuevo grupo</a></div>
            @else
            <div class="d-flex justify-content-center mt-4"><p>Sólo los usuarios registrados pueden crear grupos.</div>
